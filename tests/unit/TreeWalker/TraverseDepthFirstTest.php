...
class TraverseDepthFirstTest extends Unit
{
    /**
    ...
    ): void
    {
        ...
        // When
        foreach(TreeWalker::traverseDepthFirst($data, $childrenContainerKey) as $level => $item) {
            $actualLevels[] = $level;
    ...
    ): void
    {
        ...
        // When
        foreach(TreeWalker::traverseDepthFirst($data) as $level => $item) {
            $actualLevels[] = $level;
            $actualIds[] = $this->getId($item);
        }
